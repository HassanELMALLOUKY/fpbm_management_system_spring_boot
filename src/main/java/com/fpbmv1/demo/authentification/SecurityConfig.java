...
import com.fpbmv1.demo.authentification.filter.CustomAuthenticationFilter;
import com.fpbmv1.demo.authentification.filter.CustomAuthorisationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost:4200", "http://localhost:8081"));
